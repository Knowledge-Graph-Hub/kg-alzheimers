                ...
                dir('./gitrepo') {
                    script {
                        ...
                        withCredentials([
                            ...
                            sh "s3cmd -c \$S3CMD_CFG put -pr --acl-public --cf-invalidate output/index.html output/kg-alzheimers.tar.gz output/merged_graph_stats.yaml s3://kg-hub-public-data/kg-alzheimers/current/"
